...
function GreyFadeMessage({ message, duration = 1000, onDone }) {
  ...
  return (
    ...
    >
      <div
        style={{
          background: "#2F2F31", // card-like panel for the message
          color: "#E6E6E6",
          borderRadius: "18px",
  ...
  return (
    <div
      style={{
        ...
        height: "100vh",
        zIndex: 20000,
        background: "rgba(16,18,22,0.6)", // dark overlay
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        pointerEvents: "none",
    ...
    >
      <div
        ...
        style={{
          ...
          borderTop: "4px solid #FFEA00", // accent color for spinner top
          borderRadius: "50%",
  ...
  return (
    <div className="register-bg-hero flex items-center justify-center min-h-screen relative">
      ...
      <div className="register-content-centered z-10">
        ...
        {/* The form keeps all existing markup and handlers unchanged.
            Added inline card-style wrapper so the form area reads lighter and stands out. */}
        <form
          ...
          <div className="register-checkbox-row">
            ...
            <label htmlFor="agreed" className="register-checkbox-label" data-i18n="I agree with Terms and Conditions">
              ...
              <a
                ...
                style={{ color: "#FFEA00", fontWeight: 700, textDecoration: "underline", marginLeft: 6 }}
              >
      ...
      >
        <svg height="27" width="27" viewBox="0 0 24 24" fill="#E6E6E6">
